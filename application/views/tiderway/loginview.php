...
.mainContent {
				...
				top:50%;
				left:50%;		
				background:url(<?php echo base_url('assets/images/login.png') ?>) no-repeat;	
				margin-left:-500px;
				margin-top:-280px;
			}
.loginForm {
                        ...
                        <div class="loginForm">
                                <form class="form-signin">
                                        <div class="control-group warning">
                                                ...
                                                <input type="text" id="user_name" class="input-block-level" placeholder="用户名">
